module.exports = {
    siteUrl: `https://mostlyatechnicalblog.com`, // Site domain. Do not include a trailing slash!
    ...
    shortTitle: `Mostly a Technical Blog`, // Used for App manifest e.g. Mobile Home Screen
